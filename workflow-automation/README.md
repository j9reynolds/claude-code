...
| `reporting/` | **Recurring reports (#6):** monthly customer performance report generator (`report_customer_monthly.py`) + DGLIQ production query + framework spec. Sample: USPS Aug 2026 (177 loads, $622.7k, 6.0% margin). Email delivery gated on Microsoft 365 re-auth. |
